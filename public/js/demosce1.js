...
let objectCount = 7; // Initial object count
...
smallImages.forEach(image => {
  image.addEventListener('click', function() {
    ...
    if (this.id === 'fairyIcon' || this.id === 'fanIcon' || this.id === 'catIcon' || this.id === 'DwarfIcon' || this.id === 'keyIcon' || this.id === 'chairIcon' || this.id === 'frogIcon' || this.id === 'DoorIcon' || this.id === 'Rooster' || this.id === 'lantern' || this.id === 'Tulips' || this.id === 'Butterfly') {
