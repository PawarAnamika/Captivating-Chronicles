...
let objectCount = 12; // Initial object count
...
smallImages.forEach(image => {
  image.addEventListener('click', function() {
    ...
    if (this.id === 'fairyIcon' || this.id === 'Bird' || this.id === 'Eye' || this.id === 'DwarfIcon' || this.id === 'keyIcon' || this.id === 'frogIcon' || this.id === 'DoorIcon' || this.id === 'Rooster' || this.id === 'lantern' || this.id === 'Tulips' || this.id === 'Butterfly' || this.id === 'Key Hole' || this.id === 'Clover' || this.id === 'Starfish' || this.id === 'Sea Horse' || this.id === 'Hour Glass') {
