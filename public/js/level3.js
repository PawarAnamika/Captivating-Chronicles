...
let objectCount = 15; // Initial object count
...
smallImages.forEach(image => {
  image.addEventListener('click', function() {
    ...
    if (this.id === 'fairyIcon' || this.id === 'parrot' || this.id === 'lock' || this.id === 'DwarfIcon' || this.id === 'keyIcon' || this.id === 'Bonsai' || this.id === 'DoorIcon' || this.id === 'Rooster' || this.id === 'lantern' || this.id === 'Tulips' || this.id === 'Butterfly' || this.id === 'Key Hole' || this.id === 'Clover' || this.id === 'Starfish' || this.id === 'Tomato' || this.id === 'Hour Glass' || this.id === 'barbers pole' || this.id === 'Compass') {
